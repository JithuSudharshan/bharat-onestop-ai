    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0A1128] to-[#16213E] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Bharat OneStop</h1>
          <p className="text-blue-200/80 flex items-center justify-center gap-2">
            <ShieldCheck size={18} className="text-blue-400" /> Secure Citizen Login
          </p>
        </div>
        ...
        <GlassPanel className="p-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs font-medium text-gray-500 uppercase tracking-wider">Or continue with Phone</span>
            <div className="flex-1 h-px bg-white/10"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition-colors shadow-sm shadow-blue-600/20 flex justify-center items-center h-11"
            >
