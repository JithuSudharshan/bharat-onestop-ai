  ...
  if (generating) {
    return (
      <div className="flex flex-col items-center justify-center h-[70vh]">
        ...
        <p className="mt-8 text-white font-semibold text-xl">Gemini is analyzing your profile...</p>
        <p className="mt-2 text-blue-200/60 text-sm">Synthesizing documents, eligible schemes, and life stage.</p>
      </div>
    );
  }
